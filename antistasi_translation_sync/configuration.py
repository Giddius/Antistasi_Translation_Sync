...
class Config:
    ...
    def __init__(self) -> None:
        self._api_token_postfix: str = "TOLGEE_API_KEY"

    @property
    def api_token_postfix(self) -> str:
        return ""

    def get_tolgee_api_token(self, project_name: str) -> str:
        env_name = f"{project_name}_{self.api_token_postfix}".upper()
